...
import { Instagram, Twitter, Youtube, Palette } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-2xl font-bold text-white">Craybo</span>
            </div>
            <p className="mt-4 text-gray-400">
              Empowering creators to build thriving communities and share their passion with the world.
            </p>
          </div>
